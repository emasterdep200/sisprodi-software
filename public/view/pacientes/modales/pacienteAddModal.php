...
<div class="modal fade add-pacientes-modal" id="modal-addPacientes" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" elh-style="modal-add-paciente" style="display: none;">
    <div class="modal-dialog">
        <form class="modal-content" action="#" method="post" elh-form="insertarPaciente">
                ...
                <div class="modal-header bg-total-Pacientes text-center" >
                    <h4 class="modal-title text-white text-center">Agregar nuevo paciente</h4>
                ...
                <div class="modal-body p-0">
                    ...
                    <ul class="nav nav-tabs nav-bordered nav-justified" >
                        <li class="nav-item">
                            <a href="#datosPersonalesAdd" data-toggle="tab" aria-expanded="true" class="nav-link active">
                                1. Datos personales
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#ubicacionAdd" data-toggle="tab" aria-expanded="false" class="nav-link ">
                                2. Ubicacion
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#diagnosticoAdd" data-toggle="tab" aria-expanded="false" class="nav-link">
                                3. Diagnostico
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active px-4 py-2" id="datosPersonalesAdd">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="field-2" placeholder="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="tab-pane px-4 py-2" id="ubicacionAdd">
                    ...
                    <div class="tab-pane px-4 py-2" id="diagnosticoAdd">
