...
<div class="modal fade edit-medicamentos-modal" id="modal-addProducts" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" elh-style="modal-add-medicamentos" style="display: none;">
    <div class="modal-dialog">
        <form class="modal-content" action="#" method="post" elh-form="insertarPaciente">
            ...
            <div class="modal-header bg-total-Pacientes text-center" >
                <h4 class="modal-title text-white text-center">Editar medicamento</h4>
